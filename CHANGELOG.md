...
### Fixed
- Updated PyPI package metadata to accurately reflect 40 parsers
- Fixed version number discrepancy between PyPI and GitHub
- Enhanced project description with all 9 parser categories

### Documentation
- Updated README with accurate parser count and category breakdown
- Improved PyPI description to include all parser categories
- Synchronized version info across all documentation
